...
<div class="communication"
    ...
    <form method="get"
        ...
        <input class="communication__form__input communication__form__input--inline" style="width: 68%"
            id="<?php echo $unique_id; ?>" name="s"
            value="<?php the_search_query(); ?>" type="text"
            placeholder=<?php _e('keresőszó kifejezés', 'au'); ?>
        name="name" />

        <button style="width: 28%; vertical-align: baseline; margin-left: 2%;" type="submit"
